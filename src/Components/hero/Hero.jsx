    ...
    <section className='p-section min-h-[100vh] xl:h-[100vh]'>
        <div className='h-full mt-4 pt-8 flex flex-col'>
            <div className=' text-center font-raleway font-bold flex flex-col items-center gap-4'>
                ...
                <div ref={containerHeading} className="text-2xl md:text-4xl">
                    <h1 className="overflow-hidden">Tingkatkan Kredibilitas Bisnis</h1>
                    <h1 className="overflow-hidden">Di ranah digital</h1>
                </div>
                <p className='font-normal text-sm font-poppins '>Kami menghadirkan representasi bisnis yang profesional melalui website yang berkualitas</p>
            </div>
